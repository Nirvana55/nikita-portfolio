      ...
      >
        <Link href={href} aria-label={`Link to ${title}`}>
          <animated.div
            ...
            className={`${
              onlyImg && 'h-32 w-32'
            } bg-violet-30 dark:bg-violet-950 after:bg-texture-pattern hover:after:animate-hue-animation relative z-20
          h-full overflow-hidden rounded-md will-change-transform after:pointer-events-none after:absolute after:inset-0
          after:z-10 after:bg-cover after:bg-no-repeat after:opacity-0 after:mix-blend-hard-light
          after:transition-opacity after:duration-500 after:will-change-auto hover:after:opacity-100`}
          >
